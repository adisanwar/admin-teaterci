...
<head>
    ...
    <title>Admin Teater</title>
    <!-- Custom fonts for this template-->
    <link href="<?php echo base_url('assets/template/fontawesome-free/css/all.min.css') ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url('assets/template/datatables/dataTables.bootstrap4.min.css') ?>" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="<?= base_url('assets/template/jquery/jquery.min.js');?>"></script>
    <script src="<?= base_url('assets/template/bootstrap/js/bootstrap.bundle.min.js');?>"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?= base_url('assets/template/jquery-easing/jquery.easing.min.js');?>"></script>
